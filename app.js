...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
        ...
        res.send({
		'name': 'Greens Technologies',
		'technology': 'DevOps',
		'contact' : '9840805674',
		'email': 'saidamodaran@yahoo.com'
	            });
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('http://greenstechnologies.com');
    });
    
 
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/greenstechnologies");
      })
